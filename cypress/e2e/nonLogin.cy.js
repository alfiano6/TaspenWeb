...
describe('Pengaduan & Pertanyaan', () => {
  /*it('NL23', () => {
    ...
    cy.get("#email").type('fulan@gmail.com')
    cy.get("#phone_no").type('081234567890')
    cy.get("#name").type('fulan')
    ...
    cy.get("#message").type('Pesan ini disampaikan')
  ...
  it('NL24', () => {
    ...
    cy.get("body > div:nth-child(1) > main:nth-child(1) > nav:nth-child(1) > main:nth-child(2) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > a:nth-child(1) > div:nth-child(1)").click()
    cy.url().should('include', '/taspen-care/complaint')
    cy.get("#ticket_category_id-1").click()
    cy.get("#email").type('fulan@gmail.com')
    cy.get("#phone_no").type('081234567890')
    cy.get("#name").type('fulan')
    cy.get("#status_member").select(1).invoke("val").should("eq", "Peserta Aktif")
  ...
  it('NL25', () => {
    ...
    cy.url().should('include', '/taspen-care/complaint')
    cy.get("#ticket_category_id-2").click()
    cy.get("#email").type('iniemail')
    cy.get("#phone_no").type('np_telepon')
    cy.get("#name").type('fulan')
    cy.get("#status_member").select(1).invoke("val").should("eq", "Peserta Aktif")
    cy.get("#nip").type('111222333444')
    cy.get(".css-19bb58m").type('yogya')
    ...
    cy.get("#message").type('Pesan ini disampaikan')
    cy.get("div[class='col-md-8 mt-3'] p[class='m-0']").click()
    cy.get("body > div:nth-child(1) > main:nth-child(1) > nav:nth-child(1) > main:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3)").should('include.text','Format Tidak Sesuai')
    cy.get("body > div:nth-child(1) > main:nth-child(1) > nav:nth-child(1) > main:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(3) > div:nth-child(1) > div:nth-child(3)").should('include.text','Nomor Telepon harus angka')
  })
  ...
  it('NL26', () => {
    ...
    cy.url().should('include', '/taspen-care/complaint')
    cy.get("div[class='col-md-8 mt-3'] p[class='m-0']").click()
    cy.get("div[class='form-group mb-3 field'] div[class='invalid-feedback mt-2']").should('include.text', 'Kategori Pengaduan Wajib Diisi')
    cy.get("body > div:nth-child(1) > main:nth-child(1) > nav:nth-child(1) > main:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3)").should('include.text','Email Wajib Diisi')
    cy.get("body > div:nth-child(1) > main:nth-child(1) > nav:nth-child(1) > main:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(3) > div:nth-child(1) > div:nth-child(3)").should('include.text','No Telepon Wajib Diisi')
    cy.get("body > div:nth-child(1) > main:nth-child(1) > nav:nth-child(1) > main:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(4) > div:nth-child(1) > div:nth-child(3)").should('include.text','Nama Wajib Diisi')
    cy.get("body > div:nth-child(1) > main:nth-child(1) > nav:nth-child(1) > main:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(5) > div:nth-child(1) > div:nth-child(3)").should('include.text','Status Peserta Wajib Diisi')
    cy.get("body > div:nth-child(1) > main:nth-child(1) > nav:nth-child(1) > main:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(6) > div:nth-child(1) > div:nth-child(3)").should('include.text','Nomor Taspen / No KPE / NIP Wajib Diisi')
    cy.get("div[class='form-group mb-3 w-100 field'] div[class='invalid-feedback mt-2']").should('include.text','Wilayah Domisili Wajib Diisi')
    cy.get("body > div:nth-child(1) > main:nth-child(1) > nav:nth-child(1) > main:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(8) > div:nth-child(1) > div:nth-child(3)").should('include.text','Pesan Wajib Diisi')
  })
  ...
  it('NL27', () => {
    ...
    cy.get(".invalid-feedback").should('include.text','Nomor Tiket Wajib Diisi')
  })
  ...
  it('NL29', () => {
    ...
    cy.get("body > div:nth-child(1) > main:nth-child(1) > nav:nth-child(1) > main:nth-child(2) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > a:nth-child(1) > div:nth-child(1)").click()
    cy.url().should('include', '/taspen-care/complaint')
    cy.get("#code").type('A1234')
    cy.get("div[class='d-flex flex-column'] p[class='m-0']").click()
    cy.url().should('eq', 'https://dev-website-app.tabungselalu.id/not-found')
  })
